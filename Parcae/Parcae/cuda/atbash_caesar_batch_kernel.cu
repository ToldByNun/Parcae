...
__global__ void atbash_caesar_batch_shared_kernel(
...
Status AtbashCaesarBatchKernel::launch_device(
    ...
    return CudaError::to_status(
        cudaDeviceSynchronize(), "AtbashCaesarBatchKernel::launch_device sync");
}

Status AtbashCaesarBatchKernel::apply_host(
