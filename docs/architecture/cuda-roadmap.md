...
| 32 | feat: CUDA batch Vigenère for explicit key lists |
| 33 | feat: CUDA batch score + deterministic top-k |
...
| 41–42 | chore: version **0.3.0** + annotated tag `v0.3.0-cuda-parity` (**this**) |
