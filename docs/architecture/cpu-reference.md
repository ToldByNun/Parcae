...
include/parcae/
  ...
  dsl/           Theory DSL compiler (ingest + gate + IR + applicator + EmitCpu; EmitCuda later)
...
| `dsl` | Theory DSL compile (ingest + gate + IR + applicator + EmitCpu) | Emitted twins under `cuda/emitted/` |
