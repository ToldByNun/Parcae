...
include/parcae/
  ...
  dsl/           Theory DSL compiler (ingest + gate + Z29Expr + IR records; BuildIr later)
...
| `dsl` | Theory DSL compile (ingest + gate + IR records; BuildIr later) | Emitted twins under `cuda/emitted/` |
