...
include/parcae/
  ...
  dsl/           Theory DSL compiler (+ DslVerifier exhaustive/fuzz; CUDA mirror later)
...
| `dsl` | Theory DSL compile (+ DslVerifier exhaustive/fuzz; CUDA mirror later) | Emitted twins under `cuda/emitted/` |
