...
include/parcae/
  ...
  dsl/           Theory DSL compiler (ingest + gate + IR + applicator + EmitCpu/Cuda)
...
| `dsl` | Theory DSL compile (ingest + gate + IR + applicator + EmitCpu/Cuda) | Emitted twins under `cuda/emitted/` |
