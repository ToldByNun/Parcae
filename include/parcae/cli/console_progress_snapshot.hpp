...
public:
    ...
    void set_tool(std::string value) { tool_ = std::move(value); }

    void set_workspace_id(std::string value) { workspace_id_ = std::move(value); }

    void set_family(std::string value) { family_ = std::move(value); }

    void set_backend(std::string value) { backend_ = std::move(value); }

    void set_score_id(std::string value) { score_id_ = std::move(value); }

    void set_stage(std::string value) { stage_ = std::move(value); }

    void set_candidates_done(std::size_t value) noexcept { candidates_done_ = value; }

    void set_candidates_total(std::optional<std::size_t> value) noexcept {
        candidates_total_ = value;
    }

    void set_rune_count(std::size_t value) noexcept { rune_count_ = value; }

    void set_elapsed_seconds(double value) noexcept { elapsed_seconds_ = value; }

    void set_runes_per_sec(double value) noexcept { runes_per_sec_ = value; }

    void set_candidates_per_sec(double value) noexcept { candidates_per_sec_ = value; }

    void set_best_score(std::optional<double> value) noexcept { best_score_ = value; }

    void set_best_label(std::string value) { best_label_ = std::move(value); }
    ...
    [[nodiscard]] std::size_t candidates_done() const noexcept { return candidates_done_; }
    ...
    [[nodiscard]] double candidates_per_sec() const noexcept { return candidates_per_sec_; }

    [[nodiscard]] const std::optional<double>& best_score() const noexcept { return best_score_; }

    [[nodiscard]] const std::string& best_label() const noexcept { return best_label_; }

    [[nodiscard]] std::size_t iteration_index() const noexcept { return iteration_index_; }

    [[nodiscard]] std::size_t iteration_total() const noexcept { return iteration_total_; }
    ...
    void refresh_rates() noexcept {
        ...
        candidates_per_sec_ = static_cast<double>(candidates_done_) / elapsed_seconds_;
