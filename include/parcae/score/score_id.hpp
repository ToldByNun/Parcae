...
class ScoreId {
public:
    [[nodiscard]] static ScoreId exact_match() {
        return ScoreId{"exact_match"};
    }

    [[nodiscard]] static ScoreId hamming_agreement() {
        return ScoreId{"hamming_agreement"};
    }

    [[nodiscard]] static ScoreId ic_mod29() {
        return ScoreId{"ic_mod29"};
    }

    [[nodiscard]] static ScoreId chi2_english_gp_v0() {
        return ScoreId{"chi2_english_gp_v0"};
    }

    [[nodiscard]] static ScoreId self_repeat_rate() {
        return ScoreId{"self_repeat_rate"};
    }
