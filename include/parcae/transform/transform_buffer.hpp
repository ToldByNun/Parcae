...
namespace parcae::transform_buf {

[[nodiscard]] inline Status require_same_length(
...
[[nodiscard]] inline Status validate_interrupt_range(
...
[[nodiscard]] inline std::span<const std::size_t> skip_span(
...
[[nodiscard]] inline bool should_skip(
