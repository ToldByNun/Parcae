...
public:
    ...
    [[nodiscard]] static StatusOr<std::vector<TransformCandidate>> from_indices(
    ...
    [[nodiscard]] static StatusOr<std::vector<TransformCandidate>> from_stream(
        std::string_view generator_id,
...
private:
    ...
    [[nodiscard]] static StatusOr<std::vector<Index29>> load_indices(
        ...
        return Status::error(
            "generate_candidates: input_mode must be indices|runes|latin");
    }
    ...
    [[nodiscard]] static StatusOr<std::vector<Index29>> parse_indices_text(
